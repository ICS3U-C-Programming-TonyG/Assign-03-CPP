...
// cctype learned from https://www.programiz.com/cpp-programming/library-function/cctype
#include <iostream>
#include <string>
...
int main() {
    ...
    while (true) {
        ...
        // .length learned from https://www.w3schools.com/cpp/cpp_strings_length.asp
        // isalpha learned from https://docs.vultr.com/cpp/standard-library/cctype/isalpha
        if (userInput.length() == 1 && std::isalpha(userInput[0])) {
            char letter = userInput[0];

            // Check uppercase
            // isupper learned from https://www.programiz.com/cpp-programming/library-function/cctype/isupper
            // (tolower, toupper and islower all learned from programiz)
            if (std::isupper(letter)) {
                std::cout << "The letter you have inputted is uppercase."
                          << std::endl;
                std::cout << "The lowercase version is: "
                          << (char)std::tolower(letter) << std::endl;
            }
            // Check lowercase
            ...
            // https://www.programiz.com/cpp-programming/library-function/cctype/islower
                ...
                std::cout << "The uppercase version is: "
                          << (char)std::toupper(letter) << std::endl;
            }
            ...
            if (std::tolower(letter) <= 'm') {
                ...
                std::cout << "This letter is in the second half of the alphabet."
                          << std::endl;
            }
        } else {
